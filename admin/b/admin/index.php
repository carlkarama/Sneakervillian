...
<html>
    <head>
        ...
        <!-- Title -->
        <title><?php echo "{$_SESSION['usern']}"?> dashboard</title>
    ...
    <body class="page-header-fixed">
        ...
        <div class="menu-wrap">
            <nav class="profile-menu">
                <div class="profile"><img src="assets/images/4.jpg" width="52" alt="<?php echo "{$_SESSION['usern']}";?>"/><span><?php echo "{$_SESSION['usern']}";?></span></div>
                    ...
                    <div class="topmenu-outer">
                        <div class="top-menu">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        <span class="user-name"><?php echo "{$_SESSION['usern']}";?><i class="fa fa-angle-down"></i></span>
                                        <img class="img-circle avatar" src="assets/images/4.jpg" width="40" height="40" alt="">
                                    </a>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                <div class="sidebar-profile-image">
                                    <img src="assets/images/4.jpg" class="img-circle img-responsive"  width="200px" height="200px" alt="<?php echo "{$_SESSION['usern']}";?>">
                                </div>
                                <div class="sidebar-profile-details">
                                    <span><?php echo "{$_SESSION['usern']}";?><br><small><?php echo "{$_SESSION['rwot']}";?></small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="insert.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Insert</p></a></li>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">Party Litness</span>
                                    </div>
                                    <div class="info-box-icon">
